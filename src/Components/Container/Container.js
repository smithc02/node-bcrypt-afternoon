			...
			<div className="Container">
				{dragon
					...
					: <div className="treasureBox">
							<button
								className="title"
								onClick={() => this.getDragonTreasure()}
							>
								See Dragon's <br /> Treasure
							</button>
							<p>
								This treasure trove does not require a user to be
								logged in for access
							</p>
						</div>}
				{user && username
					? <div className="treasureBox loggedIn">
					...
					: <div className="treasureBox">
							...
							<p>
								This treasure trove requires a user to be logged
								in for access
							</p>
						</div>}
				{all && username
					...
					: <div className="treasureBox">
							...
							<p>
								This treasure trove requires a user to be a logged
								in as an admin user for access
							</p>
						</div>}
			</div>
		);
